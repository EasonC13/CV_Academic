<template lang="">
  <div>
    <nav
      id="navbar"
      class="navbar navbar-expand-lg navbar-light bg-light smart-scroll"
    >
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#Education" @click.prevent="to"
              >Education</a
            >
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#ResearchExp" @click.prevent="to"
              >Research</a
            >
          </li>
          <li class="nav-item active">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="#ProgrammingSkills" @click.prevent="to"
              >Skills</a
            >
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#Publications" @click.prevent="to"
              >Publications</a
            >
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#Speeches" @click.prevent="to"
              >Speeches</a
            >
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#Honors" @click.prevent="to"
              >Honors & Awards</a
            >
          </li>
          <li class="nav-item active">
            <a class="nav-link" href="#Languages" @click.prevent="to"
              >Languages</a
            >
          </li>
          <li class="nav-item active">
...
export default {
  ...
  async mounted() {
    ...
    // detect dark mode
    let useDarkMode = await cookieStore.get("useDarkMode");
    if (
      window.matchMedia &&
      window.matchMedia("(prefers-color-scheme: dark)").matches &&
      Boolean(window.cookieStore) &&
      useDarkMode &&
  ...
  methods: {
    ...
    async switchDark() {
      ...
      if (!this.darkMode) {
        ...
        [...document.getElementsByClassName("text-secondary")].forEach(
          (ele) => {
        ...
        [
          ...document.getElementsByClassName(
            "link-change-color-when-change-mode"
          ),
          ...document.getElementsByClassName("btn-link"),
        ].forEach((ele) => {
