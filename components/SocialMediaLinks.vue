<template lang="">
  <div class="d-inline">
    ...
    <a class="btn btn-link btn-icon" href="mailto: eason.tw.chen@gmail.com" target="_blank" rel="tooltip" title="Contact me by Email"><i class="fa fa-envelope-o"></i></a>
    ...
    <a class="btn btn-link btn-icon" href="https://www.instagram.com/eason.c13/" target="_blank" rel="tooltip" title="Follow me on Instagram"><i class="fa fa-instagram"></i></a>
  </div>
</template>
<script>
export default {
