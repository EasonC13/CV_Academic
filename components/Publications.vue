  ...
  <div id="Publications">
    ...
    <ul>
      ...
      <li>
        ...
        Edge Computing. Paper will present at International Conference on
        Artificial Intelligence in Education (AIED'22).
      </li>
      <li>
        <b>Chen, E.</b>, Tseng, Y.-H. (2022). A decision model for designing NLP
        applications. Paper presented at User Centered Natural Language
        Processing Workshop in Companion Proceedings of the Web Conference
        (WWW'22).
      </li>
      <li>
        <b>Chen, E.</b> (2022). The Effect of Multiple Replies for Natural
        Language Generation Chatbots. Paper present at Student Research
        Competition in Conference on Human Factors in Computing Systems Extended
        Abstracts (CHI EA '22).
      </li>
      <li>
        Roche, N., Hernandez, W., <b>Chen, E.</b>, Siméon, J., & Selman, D.
        (2022). Ergo--a programming language for Smart Legal Contracts. Paper
      ...
      <li>
        ...
        presented at the Taiwan Computer-Human Interaction Conference (TAICHI).
      </li>
      <li>
        <b>Chen, E.</b>, Tseng, Y.-H., Chiou, G.-L., & Yuan, C.-W. T. (2021).
        How the numbers of replies and avatars influence the user experience in
        Natural Language Generation Chatbot. Paper presented at the Taiwan
        Computer-Human Interaction Conference (TAICHI).
      </li>
    </ul>
  </div>
</template>
