<template lang="">
  <div class="" id="ResearchExp">
    ...
    <div>
      <h3 class="h5 mb-1">
        Undergraduate Research Project Principal Investigator (2021/06 -
        2022/02)
      </h3>
      <ul>
        <li>
          Researched on Building Natural Language Generation Chatbots which
          features multiple-reply and custom avatars with chosen emotion
        </li>
        <li>Compared the user experience of different chatbot designs</li>
        <li>
          Results published to CHI 2022, TAICHI 2021, and workshop of WWW 2022
          as paper
        </li>
      </ul>
    </div>
    <div>
      <h3 class="h5 mb-1">Google Summer of Code Mentee (2021/05 - 2021/09)</h3>
      <ul>
        <li>
          Contributed to Accord Project, an open source framework for Smart
          Legal Contracts
        </li>
        <li>
          Researched on Conversion of Raw Text Legal Agreements into Smart Legal
          Contracts using NLP
        </li>
        <li>
    ...
    <!-- <div class="card">
      <div class="row">
        <div data-aos="fade-right" data-aos-offset="50" data-aos-duration="500" class="col-md-3 bg-secondary aos-init aos-animate">
          <div class="card-body cc-experience-header">
            <p>2021/6 - 2022/2</p>
            <div class="h5">MOST</div>
          </div>
        </div>
      <div data-aos="fade-left" data-aos-offset="50" data-aos-duration="500" class="col-md-9 aos-init aos-animate">
        <div class="card-body">
          <div>
            <span class="h5">Undergraduate Research Project Principal Investigator</span>
          </div>
